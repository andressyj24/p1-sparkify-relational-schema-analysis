...
songplay_table_create = ("CREATE table IF NOT EXISTS songplays (songplay_id int, start_time bigint, user_id int, \
                                                                level varchar, song_id int, artist_id varchar, session_id int, \
